object fCobSantander: TfCobSantander
  Left = 7
  Top = 10
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cobran'#231'a Eletr'#244'nica Santander - Layout CNAB 240'
  ClientHeight = 548
  ClientWidth = 780
  Color = clBtnFace
  ...
  object mBoletos: TMemoryTable
    ...
    object mBoletosFormaCadastramento: TStringField
      FieldName = 'FormaCadastramento'
      Size = 1
    end
    object mBoletosCodProtesto: TStringField
      FieldName = 'CodProtesto'
      Size = 1
    end
    object mBoletosCodBaixa: TStringField
      FieldName = 'CodBaixa'
      Size = 1
    end
    object mBoletosCodCompensacao: TStringField
    ...
    object mBoletosDiasBaixa: TIntegerField
      FieldName = 'DiasBaixa'
    end
    object mBoletosVlrIOF: TFloatField
      FieldName = 'VlrIOF'
    end
    object mBoletosCodMulta: TStringField
      FieldName = 'CodMulta'
      Size = 1
    end
    object mBoletosDtMulta: TStringField
      FieldName = 'DtMulta'
      EditMask = '99/99/9999'
      Size = 10
    end
    ...
    object mBoletosTipoDesconto2: TStringField
      FieldName = 'TipoDesconto2'
      Size = 1
    end
    object mBoletosDtLimiteDesc2: TStringField
      FieldName = 'DtLimiteDesc2'
      EditMask = '99/99/9999'
      Size = 10
    end
    object mBoletosVlrDesconto2: TFloatField
      FieldName = 'VlrDesconto2'
    end
    object mBoletosMensagem1: TStringField
      FieldName = 'Mensagem1'
      Size = 40
    end
    object mBoletosMensagem2: TStringField
      FieldName = 'Mensagem2'
      Size = 40
    end
  ...
  object tCReceberParcRem2: TTable
    ...
    MasterSource = fCobrancaEletronica.dsqBoletos
  ...
  object qUltRemessa: TQuery
    DatabaseName = 'Tabelas'
    SQL.Strings = (
      'SELECT MAX( NumRemessa ) NumRemessa'
      'FROM "dbBcoSantander.DB" Dbbcosantander'
    ...
    object qUltRemessaNumRemessa: TIntegerField
      FieldName = 'NumRemessa'
      Origin = 'TABELAS."dbBcoSantander.DB".NumRemessa'
    end
  end
end
