object fArqRetornoSantander: TfArqRetornoSantander
  Left = 5
  Top = 21
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Busca Aquivo Retorno Santander (CNAB 240)'
  ClientHeight = 535
  ClientWidth = 784
  Color = clBtnFace
  ...
  object mArquivo: TClientDataSet
    ...
    FieldDefs = <
      ...
      item
        Name = 'VlrOcorrenciaSacado'
        DataType = ftFloat
      end
      item
        Name = 'CodOcorrenciaSacado'
        DataType = ftString
        Size = 4
      end
      item
        Name = 'DtOcorrenciaSacado'
        DataType = ftString
        Size = 10
      end
      item
        Name = 'ComplementoOcorrenciaSacado'
        DataType = ftString
        Size = 30
      end
      item
        Name = 'DescOcorrenciaSacado'
        DataType = ftString
        Size = 70
      end
      item
    ...
    Top = 296
    Data = {
      5B0400009619E0BD0100000018000000260000000000030000005B040D4E756D
      ...
      
      ...
      }
    ...
    object mArquivoCNPJCPF: TStringField
      FieldName = 'CNPJCPF'
      Size = 15
    end
    object mArquivoVlrLiquido: TFloatField
    ...
    object mArquivoVlrOcorrenciaSacado: TFloatField
      FieldName = 'VlrOcorrenciaSacado'
    end
    object mArquivoCodOcorrenciaSacado: TStringField
      FieldName = 'CodOcorrenciaSacado'
      Size = 4
    end
    object mArquivoDtOcorrenciaSacado: TStringField
      FieldName = 'DtOcorrenciaSacado'
      Size = 10
    end
    object mArquivoComplementoOcorrenciaSacado: TStringField
      FieldName = 'ComplementoOcorrenciaSacado'
      Size = 30
    end
    object mArquivoDescOcorrenciaSacado: TStringField
      FieldName = 'DescOcorrenciaSacado'
      Size = 70
    end
