object fProdutoCarto: TfProdutoCarto
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object RxDBLookupCombo2: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DmAux.dsqMaterialFD1
          TabOrder = 2
        end
        ...
        object RxDBLookupCombo5: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DmAux.dsqMaterialFD2
          TabOrder = 7
        end
        object RxDBLookupCombo6: TRxDBLookupCombo
          ...
          LookupField = 'CODIGO'
          LookupDisplay = 'NOME'
          LookupSource = DmAux.dsqMaterialFD3
          TabOrder = 10
        end
        ...
        object RxDBLookupCombo24: TRxDBLookupCombo
          ...
          DataField = 'SUBGRUPO1'
          DataSource = dmProdutoCarto.dsProdutoCartoFD
          LookupField = 'CodSubGrupo'
          LookupDisplay = 'NOME'
          LookupSource = DmAux.dsqGrupoItemFD1
          TabOrder = 1
        ...
        object RxDBLookupCombo26: TRxDBLookupCombo
          ...
          LookupField = 'CodSubGrupo'
          LookupDisplay = 'NOME'
          LookupSource = DmAux.dsqGrupoItemFD2
          TabOrder = 6
        ...
        object RxDBLookupCombo28: TRxDBLookupCombo
          ...
          LookupField = 'CodSubGrupo'
          LookupDisplay = 'NOME'
          LookupSource = DmAux.dsqGrupoItemFD3
          TabOrder = 9
  ...
  object sdsFacaFD: TSQLDataSet
    ...
    CommandText = 
      ...
      'B, FD_ABA_INT_LAT, FD_COPIAS_L, FD_COPIAS_C'#13#10'FROM PRODUTOCARTO P' +
      'C'#13#10'WHERE TIPO = 5'#13#10#13#10
    MaxBlobSize = -1
    Params = <>
  ...
  object sdsFacaTP: TSQLDataSet
    ...
    CommandText = 
      ...
      'T, TP_ABA_INT_LAT, TP_COPIAS_C, TP_COPIAS_L'#13#10'FROM PRODUTOCARTO P' +
      'C'#13#10'WHERE TIPO = 5'#13#10#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = dmDatabase.scoDados
  ...
  object sdsFacaSP: TSQLDataSet
    ...
    GetMetadata = False
    CommandText = 
      'SELECT PC.CODIGO, SP_COMPR, SP_LARGURA, SP_ALTURA, SP_ABA_INT_CA' +
      'B, SP_ABA_INT_LAT, SP_COPIAS_C, SP_COPIAS_L'#13#10'FROM PRODUTOCARTO P' +
      'C'#13#10'WHERE TIPO = 5'#13#10#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = dmDatabase.scoDados
    Left = 804
    Top = 482
    object sdsFacaSPCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
  ...
  object cdsFacaSP: TClientDataSet
    ...
    Left = 832
    Top = 482
    object cdsFacaSPCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
