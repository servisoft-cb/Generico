...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, RLReport, udmProdutoCarto;
...
procedure TfProdutoCartoR.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fdmProdutoCarto.cdsProdutoCartoFD_TIPO_MAT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFD_TIPO_MAT.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoTP_TIPO_MAT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoTP_TIPO_MAT.AsInteger of
      1: RLLabel9.Caption := 'DUPLEX';
      2: RLLabel9.Caption := 'MICRO';
      3: RLLabel9.Caption := 'CARTÃO / CARTÃO';
      4: RLLabel9.Caption := 'MICRO / ABAS INTERNAS';
    end;
  if not fdmProdutoCarto.cdsProdutoCartoSP_TIPO_MAT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoSP_TIPO_MAT.AsInteger of
...
procedure TfProdutoCartoR.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fdmProdutoCarto.cdsProdutoCartoFDPINCA.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDPINCA.AsString = 'S' then
      RlDraw5.Brush.Color := clBlack
  end
  else
    RlDraw5.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoFDTRAVA.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDTRAVA.AsString = 'S' then
      RlDraw6.Brush.Color := clBlack
  end
  else
    RlDraw6.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoFDDISPLAY.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDDISPLAY.AsString = 'S' then
      RlDraw7.Brush.Color := clBlack
  end
  else
    RlDraw7.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT_ATRITO.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT_ATRITO.AsString = 'S' then
      RlDraw1.Brush.Color := clBlack
  end
  else
    RlDraw1.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS_ATRITO.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS_ATRITO.AsString = 'S' then
      RlDraw2.Brush.Color := clBlack
  end
  else
    RlDraw2.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT_LUZ.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT_LUZ.AsString = 'S' then
      RlDraw4.Brush.Color := clBlack
  end
  else
    RlDraw4.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS_LUZ.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS_LUZ.AsString = 'S' then
  ...
  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoFDFECHAMENTO.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFDFECHAMENTO.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoFDFECHAMENTO_CT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFDFECHAMENTO_CT.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT_BRIL.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFDREVEST_FT_BRIL.AsInteger of
      1: RLLabel35.Caption := 'BRILHO';
      2: RLLabel35.Caption := 'FOSCO';
      3: RLLabel35.Caption := 'ALTO BRILHO';
    end;
  if not fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS_BRIL.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoFDREVEST_VS_BRIL.AsInteger of
      1: RLLabel36.Caption := 'BRILHO';
      2: RLLabel36.Caption := 'FOSCO';
      3: RLLabel36.Caption := 'ALTO BRILHO';
    end;

  if fdmProdutoCarto.cdsProdutoCartoFDAR.AsString = 'S' then
  begin
    RLLabel51.Visible   := True;
    RLDraw8.Brush.Color := clBlack;
    if not fdmProdutoCarto.cdsProdutoCartoFDAR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDAR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDBR.AsString = 'S' then
  begin
    RLLabel52.Visible   := True;
    RLDraw9.Brush.Color := clBlack;
    if not fdmProdutoCarto.cdsProdutoCartoFDBR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDBR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDHS.AsString = 'S' then
  begin
    RLDraw10.Brush.Color := clBlack;
    RLLabel54.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDHS_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDHS_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDVISOR.AsString = 'S' then
  begin
    RLDraw11.Brush.Color := clBlack;
    RLLabel53.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDVISOR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDVISOR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDVERNIZUV.AsString = 'S' then
  begin
    RLDraw12.Brush.Color := clBlack;
    RLLabel56.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDVERNIZUV_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDVERNIZUV_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDPICOTE.AsString = 'S' then
  begin
    RLDraw13.Brush.Color := clBlack;
    RLLabel62.Visible    := True;
    RLLabel66.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDPICOTE_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDPICOTE_LOCAL.AsInteger of
    ...
    if not fdmProdutoCarto.cdsProdutoCartoFDPICOTE_TIPO.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDPICOTE_TIPO.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDPASSAFITA.AsString = 'S' then
  begin
    RLDraw14.Brush.Color := clBlack;
    RLLabel63.Visible    := True;
    RLLabel67.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDPASSAFITA_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDPASSAFITA_LOCAL.AsInteger of
    ...
    if not fdmProdutoCarto.cdsProdutoCartoFDPASSAFITA_TIPO.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDPASSAFITA_TIPO.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDALCA.AsString = 'S' then
  begin
    RLDraw15.Brush.Color := clBlack;
    RLLabel65.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDALCA_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDALCA_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDILHOS.AsString = 'S' then
  begin
    RLDraw16.Brush.Color := clBlack;
    RLLabel64.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoFDILHOS_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoFDILHOS_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoFDVERNIZUV_TOTAL.AsString = 'S' then
...
procedure TfProdutoCartoR.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fdmProdutoCarto.cdsProdutoCartoTPPINCA.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoTPPINCA.AsString = 'S' then
      RlDraw22.Brush.Color := clBlack
  end
  else
    RlDraw22.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT_ATRITO.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT_ATRITO.AsString = 'S' then
      RlDraw18.Brush.Color := clBlack
  end
  else
    RlDraw18.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS_ATRITO.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS_ATRITO.AsString = 'S' then
      RlDraw19.Brush.Color := clBlack
  end
  else
    RlDraw19.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT_LUZ.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT_LUZ.AsString = 'S' then
      RlDraw21.Brush.Color := clBlack
  end
  else
    RlDraw21.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS_LUZ.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS_LUZ.AsString = 'S' then
      RlDraw20.Brush.Color := clBlack
  end
  else
    RlDraw20.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoTPFECHAMENTO.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoTPFECHAMENTO.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT_BRIL.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoTPREVEST_FT_BRIL.AsInteger of
    ...
    RLLabel84.Caption := '';
  if not fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS_BRIL.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoTPREVEST_VS_BRIL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPAR.AsString = 'S' then
  begin
    RLLabel100.Visible   := True;
    RLDraw25.Brush.Color := clBlack;
    if not fdmProdutoCarto.cdsProdutoCartoTPAR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPAR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPBR.AsString = 'S' then
  begin
    RLLabel101.Visible   := True;
    RLDraw26.Brush.Color := clBlack;
    if not fdmProdutoCarto.cdsProdutoCartoTPBR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPBR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPHS.AsString = 'S' then
  begin
    RLDraw27.Brush.Color := clBlack;
    RLLabel103.Visible   := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPHS_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPHS_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPVISOR.AsString = 'S' then
  begin
    RLDraw28.Brush.Color := clBlack;
    RLLabel102.Visible   := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPVISOR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPVISOR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPVERNIZUV.AsString = 'S' then
  begin
    RLDraw29.Brush.Color := clBlack;
    RLLabel104.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPVERNIZUV_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPVERNIZUV_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPPICOTE.AsString = 'S' then
  begin
    RLDraw30.Brush.Color := clBlack;
    RLLabel111.Visible    := True;
    RLLabel115.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPPICOTE_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPPICOTE_LOCAL.AsInteger of
    ...
    if not fdmProdutoCarto.cdsProdutoCartoTPPICOTE_TIPO.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPPICOTE_TIPO.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPPASSAFITA.AsString = 'S' then
  begin
    RLDraw31.Brush.Color := clBlack;
    RLLabel112.Visible    := True;
    RLLabel116.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPPASSAFITA_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPPASSAFITA_LOCAL.AsInteger of
    ...
    if not fdmProdutoCarto.cdsProdutoCartoTPPASSAFITA_TIPO.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPPASSAFITA_TIPO.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPALCA.AsString = 'S' then
  begin
    RLDraw32.Brush.Color := clBlack;
    RLLabel114.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPALCA_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPALCA_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPILHOS.AsString = 'S' then
  begin
    RLDraw33.Brush.Color := clBlack;
    RLLabel113.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoTPILHOS_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoTPILHOS_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoTPVERNIZUV_TOTAL.AsString = 'S' then
...
procedure TfProdutoCartoR.RLBand5BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fdmProdutoCarto.cdsProdutoCartoSPPINCA.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoSPPINCA.AsString = 'S' then
      RlDraw39.Brush.Color := clBlack
  end
  else
    RlDraw39.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT_ATRITO.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT_ATRITO.AsString = 'S' then
      RlDraw35.Brush.Color := clBlack
  end
  else
    RlDraw35.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS_ATRITO.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS_ATRITO.AsString = 'S' then
      RlDraw36.Brush.Color := clBlack
  end
  else
    RlDraw36.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT_LUZ.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT_LUZ.AsString = 'S' then
      RlDraw38.Brush.Color := clBlack
  end
  else
    RlDraw38.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS_LUZ.IsNull then
  begin
    if fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS_LUZ.AsString = 'S' then
      RlDraw37.Brush.Color := clBlack
  end
  else
    RlDraw37.Brush.Color := clWhite;

  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoSPFECHAMENTO.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoSPFECHAMENTO.AsInteger of
  ...
  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT_BRIL.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoSPREVEST_FT_BRIL.AsInteger of
    ...
    RLLabel138.Caption := '';
  if not fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS_BRIL.IsNull then
    case fdmProdutoCarto.cdsProdutoCartoSPREVEST_VS_BRIL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPAR.AsString = 'S' then
  begin
    RLLabel154.Visible   := True;
    RLDraw42.Brush.Color := clBlack;
    if not fdmProdutoCarto.cdsProdutoCartoSPAR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPAR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPBR.AsString = 'S' then
  begin
    RLLabel155.Visible   := True;
    RLDraw43.Brush.Color := clBlack;
    if not fdmProdutoCarto.cdsProdutoCartoSPBR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPBR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPHS.AsString = 'S' then
  begin
    RLDraw44.Brush.Color := clBlack;
    RLLabel157.Visible   := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPHS_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPHS_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPVISOR.AsString = 'S' then
  begin
    RLDraw45.Brush.Color := clBlack;
    RLLabel156.Visible   := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPVISOR_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPVISOR_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPVERNIZUV.AsString = 'S' then
  begin
    RLDraw46.Brush.Color := clBlack;
    RLLabel158.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPVERNIZUV_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPVERNIZUV_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPPICOTE.AsString = 'S' then
  begin
    RLDraw47.Brush.Color := clBlack;
    RLLabel165.Visible    := True;
    RLLabel169.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPPICOTE_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPPICOTE_LOCAL.AsInteger of
    ...
    if not fdmProdutoCarto.cdsProdutoCartoSPPICOTE_TIPO.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPPICOTE_TIPO.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPPASSAFITA.AsString = 'S' then
  begin
    RLDraw48.Brush.Color := clBlack;
    RLLabel166.Visible    := True;
    RLLabel170.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPPASSAFITA_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPPASSAFITA_LOCAL.AsInteger of
    ...
    if not fdmProdutoCarto.cdsProdutoCartoSPPASSAFITA_TIPO.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPPASSAFITA_TIPO.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPALCA.AsString = 'S' then
  begin
    RLDraw49.Brush.Color := clBlack;
    RLLabel168.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPALCA_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPALCA_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPILHOS.AsString = 'S' then
  begin
    RLDraw50.Brush.Color := clBlack;
    RLLabel167.Visible    := True;
    if not fdmProdutoCarto.cdsProdutoCartoSPILHOS_LOCAL.IsNull then
      case fdmProdutoCarto.cdsProdutoCartoSPILHOS_LOCAL.AsInteger of
  ...
  if fdmProdutoCarto.cdsProdutoCartoSPVERNIZUV_TOTAL.AsString = 'S' then
